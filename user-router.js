...
// ----------------------------------------------------------------------------------------------
// ⚠ ➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖ ⚠
// ⚠ RULES TO FOLLOW WHILE WRITING ROUTER CODE ⚠
// ⿡ your arrow function should start with [ async ] 
// ⿢ your database model code always prefix with [ await ]
//     NOTE: Every database model code should prefix with [ await ]
//     Example:   await UserModel.find({})
//     Example:   await UserModel.deleteOne({})
// ⿣ It is mandatory to use try catch.
